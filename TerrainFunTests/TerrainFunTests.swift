...
{
	var marsMola1024: URL!
	var marsMolaFull: URL!
	var somewhereInUS: URL!
	...
	setUpWithError()
		throws
	{
		let tdp = URL(fileURLWithPath: Bundle.main.infoDictionary?["TestDataDirectory"] as! String, isDirectory: true)
		self.marsMola1024 = URL(fileURLWithPath: "Mars_HRSC_MOLA_BlendDEM_Global_200mp_1024.tif", relativeTo: tdp)
		self.marsMolaFull = URL(fileURLWithPath: "Mars_HRSC_MOLA_BlendDEM_Global_200mp_v2.tif", relativeTo: tdp)
		self.somewhereInUS = URL(fileURLWithPath: "USGS_13_n36w112.tif", relativeTo: tdp)
	}
